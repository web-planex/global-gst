                        ...
                        <tr>
                            <td align="center" valign="top" bgcolor="#FFFFFF">
                                <table width="94%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td align="left" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:20px;">
                                            <a style="display:inline-block;background-color: #3f4eae; color: #ffffff; border-left:20px solid #3f4eae; border-right:20px solid #3f4eae; border-top:10px solid #3f4eae; border-bottom:10px solid #3f4eae; text-decoration:none;" href="{{route('invoice-download_pdf',['id'=>$credit_note_id,'output'=>'download','type'=>'credit_note'])}}" target="_blank">

                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td align="right" style="padding-bottom:6px; color:#fff; vertical-align:top;">
                                                                <strong>Payment Date:</strong>{{date('d-m-Y', strtotime($expense['expense_date']))}}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right" style="padding-bottom:6px; color:#fff; vertical-align:top;">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr style="background-color: #313131">
        ...
        <td width="240px" valign="middle" align="left" style="color: #fff; font-size:14px; font-weight:bold; border-bottom: solid 1px #fff;"><strong>Expense Type</strong></td>
        <td width="100px" align="center" valign="middle" style="color: #fff; font-size:14px; font-weight:bold; border-bottom: solid 1px #fff;"><strong>Note</strong></td>
    ...
    @if(!empty($expense['ExpenseItems']))
        ...
        @foreach($expense['ExpenseItems'] as $item)
            ...
            <tr style="background-color: @if($i%2 == 0) #f1f1f1 @else #e8e8e8 @endif">
                ...
                <td style="padding:0 5px;line-height:30px; border-bottom: solid 2px #fff;" align="left" valign="top">
                ...
                <td style="line-height:30px; border-bottom: solid 2px #fff;" align="center" valign="top"><span class="taxable-input">{{number_format($item['amount'], 2)}}</span></td>
                @if($expense['tax_type'] != 3)

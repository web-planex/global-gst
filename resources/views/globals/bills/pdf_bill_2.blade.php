            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td >
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td align="center" height="40" bgcolor="#bcd6ee" style="border-bottom: solid 2px #000;border-top: solid 2px #000;padding:0 5px; font-size:20px;"><strong>Bill</strong><br></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                    ...
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="table-top">
                            <tr>
                                ...
                                <td width="285.5px" style="padding:0 5px;border-bottom: solid 1px #000;border-right: solid 1px #000;">Bill Date :<strong> {{date('d-m-Y', strtotime($bill['bill_date']))}}</strong></td>
                            </tr>
                            <tr>
    ...
    <tr>
        <td align="left" width="579px" valign="top" style="border-right: solid 1px #000;">
            <table width="100%" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td height="107" align="center">{{ucwords($bill['total_in_word'])}} Rupees Only</td>
                </tr>
                <tr>
        ...
        <td width="599px" align="left" valign="top" >
            <table width="100%" border="0" cellspacing="0" cellpadding="2" style="margin-right: -1px; margin-bottom: -0.5px;">
                <tr>
                    ...
                    <td  width="299.5px" align="right" height="35"  style="border-right:0px;border-bottom:solid 1px #000;padding: 5px 5px;line-height:30px;">{{number_format($bill['amount_before_tax'],2)}}/-</td>
                </tr>
                <tr>
                    ...
                    <td width="299.5px" align="right"  height="35"  style="border-right:0px;border-bottom:solid 1px #000;padding:5px 5px;line-height:30px;">{{number_format($bill['tax_amount'],2)}}/-</td>
                </tr>
                    ...
                    <td width="299.5px" style="border-right:solid 1px #000;border-bottom:solid 1px #000;">
                        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse; margin-top:-2px; margin-bottom: -2px;">
                            <tr>
                                ...
                                <td align="right" style="padding:5px 5px;line-height:30px;border-left:solid 1px #000;">@if($bill['discount_type']==1) {{$bill['discount']}} % @else - @endif</td>
                            </tr>
                        </table>
                    </td>
                    <td width="299.5px" style="border-bottom:solid 1px #000;">
                        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse; margin-top:-2px; margin-bottom: -2px;">
                            <tr>
                                ...
                                <td align="right"  style="width:100px;padding:5px 5px;line-height:30px;border-left:solid 1px #000;">@if(!empty($bill['discount_price']) && $bill['discount_price']>0) {{$bill['discount_price']}}/- @endif</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="299.5px" align="right"  style="border-right:0px;border-bottom:solid 1px #000;padding:5px 5px;line-height:30px;">
                        {{$bill['shipping_charge']==1 ? number_format($bill['shipping_charge_amount'],2).'/-' : '-' }}&nbsp;&nbsp;
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="299.5px" align="right"  style="border-right:0px;border-bottom:solid 1px #000;padding:5px 5px;line-height:30px;">{{number_format($bill['total'],2)}}/-</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="299.5px" align="right"  style="border-right:0px;border-bottom:solid 1px #000;padding:5px 5px;line-height:30px;"><strong>{{number_format(round($bill['total']),2)}}/-</strong></td>
                </tr>
                <tr>

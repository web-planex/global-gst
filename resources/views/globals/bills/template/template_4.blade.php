                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="left" width="28%"
                                        ...
                                        <h3 style="font-size: 20px !important;">&nbsp;&nbsp;Bill
                                        </h3>
                                    </td>
                            ...
                            <table border="0" width="100%" cellspacing="0" cellpadding="0" id="table-top">
                                ...
                                <tr>
                                    <td align="left" style="padding:5px 15px;border-left:solid 1px #444444;border-top:solid 1px #444444;border-bottom:solid 1px #444444;">
                                        Bill Date:<strong>{{date('d-m-Y', strtotime($bill['bill_date']))}}</strong>
                                    </td>
                    ...
                    <tr>
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0" id="table-top2" width="100%">
                                ...
                                <tr>
                                    <td @if($print_type==2) colspan="2" @elseif($user['is_shipping']==0) colspan="2" @endif align="center" width="50%" style="border-left:solid 1px #444444;border-right:solid 1px #444444;border-top:solid 1px #444444; padding:0 5px;line-height:30px;">
                                ...
                                <tr>
                                    <td @if($print_type==2) colspan="2" @elseif($user['is_shipping']==0) colspan="2" @endif align="left" style="border:solid 1px #444444;padding:0 5px;line-height:30px; font-weight: bold;">
                                        &nbsp;&nbsp;{{$user['billing_name']}}
                                    </td>
                                    @if($user['is_shipping']==1 && $print_type==1)
                                ...
                                <tr>
                                    <td @if($print_type==2) colspan="2" @elseif($user['is_shipping']==0) colspan="2" @endif align="left" valign="top" style="border:solid 1px #444444;padding:0 5px;line-height:30px;">
                                ...
                                <tr>
                                    <td @if($print_type==2) colspan="2" @elseif($user['is_shipping']==0) colspan="2" @endif align="left" style="border:solid 1px #444444;border-bottom:0px; padding:0 5px;line-height:30px;">
                                            ...
                                            {{-- <tr>
                                                <td style="padding:10px;" valign="bottom">
                                                    <div style="font-weight: bold;">
                                                        {{ $bill_label['total_amount_in_word'] }}
                                                    </div>

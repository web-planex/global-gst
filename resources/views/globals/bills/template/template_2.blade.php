                                                ...
                                                <table width="100%" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td width="50%" align="left" style="background-color:#{{$company->color}}; border: solid 1px #{{$company->color}};">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td style="font-size:14px; padding:10px 10px 0 10px; color:#fff;">Bill Date</td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="left" style="font-size:14px; font-weight: normal; text-transform: uppercase; color:#383838; padding:5px 10px 10px 10px; color:#fff;">
                                                                        <strong>{{date('d-m-Y', strtotime($bill['bill_date']))}}</strong>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                        <td width="50%" style="border: solid 1px #{{$company->color}};">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td align="left" style="font-size:14px; padding:10px 10px 0 10px;">Bill No.</td>
                                                                </tr>
                                                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td width="40%" align="right" valign="top">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tbody>
    {{--                                        <tr>--}}
    {{--                                            <td colspan="2" align="left" valign="middle" style="font-size:12px; font-weight:bold; padding-bottom: 5px;">{{ $bill_label["shipping_method"] }}</td>--}}
    {{--                                        </tr>--}}
    {{--                                        <tr>--}}
                                            ...
                                            <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                {{-- <tr>
                                                  <td valign="top" height="20"
                                                    ...
                                                    <strong>{{ $bill_label['total_amount_in_word'] }}</strong></td>
                                                </tr>
                                                <tr>
                                                  <td style="padding: 0px 0px 10px 0px;">
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td height="24" width="110" align="right" style="font-size:12px;padding:0 0px;">
                                                        <strong>{{number_format($bill['amount_before_tax'],2)}}</strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="24" align="right" style="font-size:12px;padding-right:10px;">
                                                    ...
                                                    <td height="24" align="right" style="font-size:12px;padding:0 5px;">
                                                        <strong>{{number_format($bill['tax_amount'],2)}}</strong>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td height="24" align="right" style="font-size:12px;padding:0 5px;">
                                                        <strong>@if(!empty($bill['discount_price'])){{$bill['discount_price']}} @else - @endif</strong>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td height="24" align="right" style="font-size:12px;padding:0 5px;">
                                                        <strong>{{$bill['shipping_charge']==1 ? number_format($bill['shipping_charge_amount'],2).'' : '-' }}</strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="24" align="right" style="font-size:12px;padding-right:10px;">
                                                ...
                                                <tr bgcolor="#{{$company->color}}">
                                                    ...
                                                    <td height="30" align="right" style="font-size:14px;padding:12px 6px; color: #fff;">
                                                        <strong>{{number_format(round($bill['total']),2)}}</strong>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>

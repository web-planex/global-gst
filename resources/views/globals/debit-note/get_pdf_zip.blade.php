...
<div class="row page-titles">
    <div class="col-sm-12 align-self-center">
        <h4 class="text-themecolor">Download Debit Note Zip files</h4>
    </div>
</div>
<div class="row">
    <div class="col-12">
                            ...
                            <table class="tablesaw no-wrap table-hover table" data-tablesaw-mode="stack">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Debit Note</td>
                                        <td>
                                            <a href="{{ URL::to('/') }}/upload/{{$user_id}}/debit_note/{{$zip_file->zip_name}}" class="btn waves-effect waves-light btn-success" target="_blank"><i class="fas fa-download"></i> Download</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @else

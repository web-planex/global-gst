                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="hidden" name="state_code" id="state_code" value="@if(isset($debit_note) && !empty($debit_note)) {{$debit_note['customer']['billing_state_code']}} @endif">
                                ...
                                <div class="card-body item-details-box">
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <th class="tax_column @if(isset($debit_note)&&$debit_note['tax_type']==3) hide @endif">Tax <span class="text-danger">*</span></th>
                                            <th>&nbsp;</th>
                                            </thead>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover" id="Tax-Calculation">
                                                        ...
                                                        @foreach($all_tax_labels as $tax)
                                                            ...
                                                            @if(isset($debit_note) && !empty($debit_note))
                                                                @if($debit_note['customer']['billing_state_code'] == $company['state'])
                                                                    @if($tax_name == 'GST')

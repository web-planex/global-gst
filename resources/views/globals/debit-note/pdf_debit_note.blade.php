...
@endif
    ...
    <table class="td-gray" width="1182" border="1" cellspacing="0" cellpadding="0" id="table-top2">
        ...
        <tr>
            <td @if($user['is_shipping']==0) colspan="2" @endif bgcolor="#eeeeee" align="center" style="padding:0 5px;line-height:30px;"><strong>BILL TO PARTY</strong></td>
        ...
        <tr>
            <td @if($user['is_shipping']==0) colspan="2" @endif align="left" valign="top" style="padding:0 14px;line-height:30px;">{{$user['billing_street']}}, {{$user['billing_city']}}-{{$user['billing_pincode']}}, {{$user['state']}}, {{$user['billing_country']}}.</td>
            @if($user['is_shipping']==1)
            ...
            @foreach($debit_note['DebitNoteItems'] as $item)
                @php
                    ...
                    if($debit_note['tax_type']==1){
                     ...
                     //$total_tax = in_array($debit_note['tax_type'],[1,2]) ? $item['amount'] * $item['tax_rate'] / 100 : 0;
                    if($debit_note['discount_level']==1){
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td valign="top" style="padding:15px 15px 5px 15px;border-bottom:solid 1px #444444;">
                            <table cellspacing="0" cellpadding="0" border="0">
                                ...
                                <tr>
                                    <td style="padding: 5px 0px;">{{$debit_note['notes']}}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:5px 15px;" valign="bottom">
                            <table  width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                <tr>
                                    <td><strong>Total Debit Note Amount in Words</strong></td>
                                </tr>
                                <tr>
                                    <td style="padding: 5px 0px;">{{ucwords($debit_note['total_in_word'])}} Ruppes Only</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
            ...
            <td width="50%" align="left" valign="top" style="border-right: solid 1px #444444;border-top: solid 1px #444444; line-height: 35px;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td align="right" height="35" style="border-right:0px;border-bottom:solid 1px #444444;">{{$debit_note['amount_before_tax']}}&nbsp;&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td align="right" height="35" style="border-right:0px;border-bottom:solid 1px #444444;">{{$debit_note['tax_amount']}}&nbsp;&nbsp;</td>
                    </tr>
...
{{--                        @endif--}}
{{--                    @endforeach--}}
                    @if($debit_note['discount_level'] == 0)
                    <tr>
                        <td style="border-right:solid 1px #444444;border-bottom:solid 1px #444444;">
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse; ">
                                <tr>
                                    ...
                                    <td align="right" style="border-left:solid 1px #444444; text-align: center;">@if($debit_note['discount_type']==1) {{$debit_note['discount']}} % @else - @endif</td>
                                </tr>
                            </table>
                        </td>
                        <td style="border-bottom:solid 1px #444444;">
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse; ">
                                <tr>
                                    ...
                                    <td align="right" style="width:100px;border-left:solid 1px #444444;">{{$debit_note['discount']}}&nbsp;&nbsp;</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="right" style="border-right:0px;border-bottom:solid 1px #444444;">{{$debit_note['shipping_charge']==1 ? $debit_note['total'] - str_replace(',','',$debit_note['shipping_charge_amount']) : $debit_note['total']}}&nbsp;&nbsp;</td>
                    </tr>
                    <tr>
        ...
        <tr>
            ...
            <td align="right" style="padding:0 10px 20px; border-bottom: solid 1px #444444;border-right:solid 1px #444444;line-height:30px;">
                ...
                <br>
                This is computer generated debit note and does not require a signature
            </td>
        </tr>
    </table>

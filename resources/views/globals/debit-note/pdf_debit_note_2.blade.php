            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td >
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td align="center" height="40" bgcolor="#bcd6ee" style="border-bottom: solid 2px #000;border-top: solid 2px #000;padding:0 5px; font-size:20px;"><strong>Debit Note</strong><br></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="table-top">
                            <tr>
                                <td width="295.5px" height="25" style="padding:0 5px;border-bottom: solid 1px #000;border-right: solid 1px #000;" >
                                    Debit Note No. : <strong>{{$debit_note['debit_note_number']}}</strong>
                                </td>
                                <td width="285.5px" style="padding:0 5px;border-bottom: solid 1px #000;border-right: solid 1px #000;">Debit Note Date :<strong> {{date('d-m-Y', strtotime($debit_note['debit_note_date']))}}</strong></td>
                                <td width="295.5px" style="padding:0 5px;border-bottom: solid 1px #000;border-right: solid 1px #000;">Invoice No :<strong> {{$invoice['invoice_number']}}</strong></td>
                                <td width="305.5px" style="padding:0 5px;border-bottom: solid 1px #000;">Invoice Date :<strong> {{$debit_note['ref_invoice_date']}}</strong></td>
                            </tr>
                            <tr>
                                <td width="295.5px" height="25" style="padding:0 5px;border-bottom: solid 1px #000;border-right: solid 1px #000;">Order No : <strong>{{$debit_note['order_number']}}</strong></td>
...
<table width="1182" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr align="center" bgcolor="#bcd6ee" style="padding:0;">
        ...
        @if($debit_note['discount_level']==1)
...
{{--        @endif--}}
    ...
    @if(!empty($debit_note['DebitNoteItems']))
        @php
            ...
            $maintotal = 0;
        @endphp
        @foreach($debit_note['DebitNoteItems'] as $item)
            @php
            ...
            @php $i++; @endphp
        @endforeach
        @for($i=1; $i<=($debit_note['DebitNoteItems']->count()>0?10-$debit_note['DebitNoteItems']->count():10); $i++)
            <tr>
    ...
    <tr>
        <td align="left" width="579px" valign="top" style="border-right: solid 1px #000;">
            <table width="100%" cellspacing="0" cellpadding="0">
                <tr>
                    <td height="40" align="center" style="border-bottom: solid 1px #000; padding: 5px 5px; background-color:#bcd6ee;"><strong>Total Debit Note amount in words</strong></td>
                </tr>
                <tr>
                    <td height="107" align="center">{{ucwords($debit_note['total_in_word'])}} Rupees Only</td>
                </tr>
                <tr>
                    <td align="left" style="border-top: solid 1px #000; padding:5px;"><strong>Payment Mode : </strong>{{$payment_method['method_name']}}</td>
                </tr>
                <tr>
        ...
        <td width="599px" align="left" valign="top" >
            <table width="100%" border="0" cellspacing="0" cellpadding="2" style="margin-right: -1px; margin-bottom: -0.5px;">
                <tr>
                    ...
                    <td  width="299.5px" align="right" height="35"  style="border-right:0px;border-bottom:solid 1px #000;padding: 5px 5px;line-height:30px;">{{number_format($debit_note['amount_before_tax'],2)}}/-</td>
                </tr>
                <tr>
                    ...
                    <td width="299.5px" align="right"  height="35"  style="border-right:0px;border-bottom:solid 1px #000;padding:5px 5px;line-height:30px;">{{number_format($debit_note['tax_amount'],2)}}/-</td>
                </tr>
                    ...
                    <td width="299.5px" style="border-right:solid 1px #000;border-bottom:solid 1px #000;">
                        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse; margin-top:-2px; margin-bottom: -2px;">
                            <tr>
                                ...
                                <td align="right" style="padding:5px 5px;line-height:30px;border-left:solid 1px #000;">@if($debit_note['discount_type']==1) {{$debit_note['discount']}} % @else - @endif</td>
                            </tr>
                        </table>
                    </td>
                    <td width="299.5px" style="border-bottom:solid 1px #000;">
                        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse; margin-top:-2px; margin-bottom: -2px;">
                            <tr>
                                ...
                                <td align="right"  style="width:100px;padding:5px 5px;line-height:30px;border-left:solid 1px #000;">@if(!empty($debit_note['discount_price']) && $debit_note['discount_price']>0) {{$debit_note['discount_price']}}/- @endif</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="299.5px" align="right"  style="border-right:0px;border-bottom:solid 1px #000;padding:5px 5px;line-height:30px;">
                        {{$debit_note['shipping_charge']==1 ? number_format($debit_note['shipping_charge_amount'],2).'/-' : '-' }}&nbsp;&nbsp;
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="299.5px" align="right"  style="border-right:0px;border-bottom:solid 1px #000;padding:5px 5px;line-height:30px;">{{number_format($debit_note['total'],2)}}/-</td>
                </tr>
                <tr>
                    ...
                    <td width="299.5px" align="right"  style="border-right:0px;border-bottom:solid 1px #000;padding:5px 5px;line-height:30px;">
                        @php
                            $total_arr = explode('.',$debit_note['total']);
                            $j = '0.'.$total_arr[1];
                            $round = round($j);
                        @endphp
                ...
                <tr>
                    ...
                    <td width="299.5px" align="right"  style="border-right:0px;border-bottom:solid 1px #000;padding:5px 5px;line-height:30px;"><strong>{{number_format(round($debit_note['total']),2)}}/-</strong></td>
                </tr>
                <tr>
...
{{--                            <img src="{{url('assets/images/pdf_img/'.$debit_note['status_image'])}}" alt="" width="150" height="70" />--}}
{{--                        @endif--}}
{{--                    </td>--}}

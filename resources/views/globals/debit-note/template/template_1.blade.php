                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                            <tr>
                                                <td align="left" style="font-size:14px; padding-bottom: 5px;">
                                                    <strong style="color:#{{$company->color}};">Debit Note No: </strong>{{$debit_note['debit_note_number']}}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="60" align="left" valign="top" style="font-size:14px; padding-bottom:20px;">
                                                    <strong style="color:#{{$company->color}};">Debit Note Date: </strong>
                                                    {{date('d-m-Y', strtotime($debit_note['debit_note_date']))}}
                                                </td>
                                            </tr>
                                            <tr>
    ...
    <table align="center" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            @if($debit_note['discount_level']==1)
                <td width="100px" align="center" valign="top" bgcolor="#{{$company->color}}" style=" color: #ffffff; border-left: solid 2px #fff; padding:0 5px;line-height:30px; text-transform: uppercase;"><strong>DISCOUNT ITEM <span style="font-family: DejaVu Sans; sans-serif;">(&#8377;)</span></strong></td>
            @endif
        ...
        @if(!empty($debit_note['DebitNoteItems']))
            ...
            @foreach($debit_note['DebitNoteItems'] as $item)
                ...
                <tr style="background-color: @if($i%2 == 0) #e8e8e8 @else #f1f1f1 @endif">
                    ...
                    <td style="padding:0 5px;line-height:30px; border: solid 2px #fff;" align="left" valign="top">{{$item['Product']['title']}} @if(!empty($item['Product']['sku'])) - {{$item['Product']['sku']}} @endif</td>
                    <td style="line-height:30px; border: solid 2px #fff;" align="center" valign="top"><span class="quantity-input">{{$item['quantity']}}</span></td>
                    <td style="line-height:30px; border: solid 2px #fff;" align="center" valign="top"><span class="rate-input">{{number_format($item['rate'], 2)}}</span></td>
                    @if($debit_note['discount_level']==1)
                    ...
                    <td style="line-height:30px; border: solid 2px #fff;" align="center" valign="top">{{$item['hsn_code']}}</td>
                    @if($debit_note['tax_type'] != 3)
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                ...
                                <tr class="odd">
                                    ...
                                    <td height="35" width="110" align="right" style="border: solid 2px #fff; padding:0 10px;">
                                        {{number_format($debit_note['amount_before_tax'],2)}}
                                    </td>
                                </tr>
                                <tr class="even">
                                    <td height="35" align="right" style="border: solid 2px #fff; padding-right:10px;">
                                    ...
                                    <td height="35" align="right" style="border: solid 2px #fff; padding:0 10px;">
                                        {{number_format($debit_note['tax_amount'],2)}}
                                    </td>
                                </tr>
                                ...
                                <tr class="odd">
                                    ...
                                    <td height="35" align="right" style="border: solid 2px #fff; padding:0 10px;">
                                        @if(!empty($debit_note['discount_price'])){{$debit_note['discount_price']}} @else - @endif
                                    </td>
                                </tr>
                                <tr class="even">
                                    <td height="35" align="right" style="border: solid 2px #fff; padding-right:10px;">

...
<table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 15px; background-color:#f2f2f2;">
    <tr>
        ...
        @if($debit_note['discount_level']==1)
            <td width="100px" align="center" valign="middle" style="background-color:#{{$company->color}};color: #fff; font-size:13px; font-weight:400; padding:0 10px;"><strong>DISCOUNT ITEM <span style="font-family: DejaVu Sans; sans-serif;">(&#8377;)</span></strong></td>
        @endif
    ...
    @if(!empty($debit_note['DebitNoteItems']))
        ...
        @foreach($debit_note['DebitNoteItems'] as $item)
            ...
            <tr>
                ...
                <td style="border: solid 1px #b7b7b7; font-size:12px; padding:5px 10px; line-height: 20px;" align="left" valign="top">{{$item['Product']['title']}} @if(!empty($item['Product']['sku'])) - {{$item['Product']['sku']}} @endif</td>
                <td style="border: solid 1px #b7b7b7; font-size:12px; padding:5px 10px; line-height: 20px;" align="center" valign="top"><span class="quantity-input">{{$item['quantity']}}</span></td>
                ...
                @if($debit_note['discount_level']==1)
                    <td style="border: solid 1px #b7b7b7; font-size:12px; padding:5px 10px; line-height: 20px;" align="center" valign="top">
                ...
                <td style="border: solid 1px #b7b7b7; font-size:12px; padding:5px 10px; line-height: 20px;" align="center" valign="top">{{$item['hsn_code']}}</td>
                @if($debit_note['tax_type'] != 3)

                                                ...
                                                <table width="100%" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td width="50%" align="left" style="background-color:#{{$company->color}}; border: solid 1px #{{$company->color}};">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td style="font-size:14px; padding:10px 10px 0 10px; color:#fff;">Debit Note Date</td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="left" style="font-size:14px; font-weight: normal; text-transform: uppercase; color:#383838; padding:5px 10px 10px 10px; color:#fff;">
                                                                        <strong>{{date('d-m-Y', strtotime($debit_note['debit_note_date']))}}</strong>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                        <td width="50%" style="border: solid 1px #{{$company->color}};">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td align="left" style="font-size:14px; padding:10px 10px 0 10px;">Debit Note No.</td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="left" style="font-size:14px; font-weight:normal; text-transform: uppercase; color:#383838; padding:5px 10px 10px 10px;">
                                                                        <strong>{{$debit_note['debit_note_number']}}</strong>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                ...
                                <tr>
                                    ...
                                    <td width="40%" align="right" valign="top">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tbody>
    {{--                                        <tr>--}}
    {{--                                            <td colspan="2" align="left" valign="middle" style="font-size:12px; font-weight:bold; padding-bottom: 5px;">{{ $debit_note_label["shipping_method"] }}</td>--}}
    {{--                                        </tr>--}}
    {{--                                        <tr>--}}
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            @if($debit_note['discount_level']==1)
                <td width="100px" align="center" valign="top" bgcolor="#{{$company->color}}" style=" color: #ffffff; border-bottom: solid 1px #b7b7b7; padding:0 5px;line-height:30px; text-transform: uppercase;"><strong>DISCOUNT ITEM <span style="font-family: DejaVu Sans; sans-serif;">(&#8377;)</span></strong></td>
            @endif
        ...
        @if(!empty($debit_note['DebitNoteItems']))
            ...
            @foreach($debit_note['DebitNoteItems'] as $item)
                ...
                <tr>
                    ...
                    <td style="padding:0 5px;line-height:30px; border-bottom: solid 1px #b7b7b7; " align="left" valign="top">{{$item['Product']['title']}} @if(!empty($item['Product']['sku'])) - {{$item['Product']['sku']}} @endif</td>
                    <td style="line-height:30px; border-bottom: solid 1px #b7b7b7; background-color:#f1f1f1;" align="center" valign="top"><span class="quantity-input">{{$item['quantity']}}</span></td>
                    ...
                    @if($debit_note['discount_level']==1)
                        <td style="line-height:30px; border-bottom: solid 1px #b7b7b7; " align="center" valign="top">
                    ...
                    @endif
                    <td style="line-height:30px; border-bottom: solid 1px #b7b7b7; background-color:#f1f1f1; " align="center" valign="top">
                    ...
                    <td style="line-height:30px; border-bottom: solid 1px #b7b7b7; " align="center" valign="top">{{$item['hsn_code']}}</td>
                    @if($debit_note['tax_type'] != 3)
...
{{--            @for($j=1; $j<=($debit_note['DebitNoteItems']->count()>0?10-$debit_note['DebitNoteItems']->count():10); $j++)--}}
{{--                <tr>--}}
{{--                    <td style="width: 5%; background-color: #ffffff!important;">&nbsp;</td>--}}
                                            ...
                                            <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                {{-- <tr>
                                                  <td valign="top" height="20"
                                                    ...
                                                    <strong>{{ $debit_note_label['total_amount_in_word'] }}</strong></td>
                                                </tr>
                                                <tr>
                                                  <td style="padding: 0px 0px 10px 0px;">
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td height="24" width="110" align="right" style="font-size:12px;padding:0 0px;">
                                                        <strong>{{number_format($debit_note['amount_before_tax'],2)}}</strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="24" align="right" style="font-size:12px;padding-right:10px;">
                                                    ...
                                                    <td height="24" align="right" style="font-size:12px;padding:0 5px;">
                                                        <strong>{{number_format($debit_note['tax_amount'],2)}}</strong>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td height="24" align="right" style="font-size:12px;padding:0 5px;">
                                                        <strong> @if(!empty($debit_note['discount_price'])){{$debit_note['discount_price']}} @else - @endif</strong>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td height="24" align="right" style="font-size:12px;padding:0 5px;">
                                                        <strong>{{$debit_note['shipping_charge']==1 ? number_format($debit_note['shipping_charge_amount'],2).'' : '-' }}</strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="24" align="right" style="font-size:12px;padding-right:10px;">
                                                    ...
                                                    <td height="24" align="right" style="font-size:12px;padding:0 5px;">
                                                        <strong>{{number_format($debit_note['total'],2)}}</strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="24" align="right" style="font-size:12px;padding-right:10px;">
                                                ...
                                                <tr bgcolor="#{{$company->color}}">
                                                    ...
                                                    <td height="30" align="right" style="font-size:14px;padding:12px 6px; color: #fff;">
                                                        <strong>{{number_format(round($debit_note['total']),2)}}</strong>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>

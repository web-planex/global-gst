            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td valign="top" style="padding:0; line-height: 25px;" align="center">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td align="left" width="33%" style="font-size:18px; padding-bottom: 6px;padding-left:10px; padding-top: 5px;">
                                    @if($company['iec_code'] != '')
                                ...
                                <td align="center" style="font-size:20px; padding-bottom: 6px;padding-left:30px;">
                                    <strong>{{$company['company_name']}}</strong>
                                </td>
                                <td align="right" width="33%" style="font-size:17px; padding-top: 5px; padding-bottom: 6px; padding-right:10px;">
                    ...
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="table-top">
                            <tr>
                                ...
                                <td width="285.5px" style="padding:0 5px;border-bottom: solid 1px #000;border-right: solid 1px #000;">Estimate Date :<strong> {{date('d-m-Y', strtotime($estimate['estimate_date']))}}</strong></td>
                                <td width="295.5px" colspan="2" style="padding:0 5px;border-bottom: solid 1px #000;border-right: solid 1px #000;">@if($print_type==1)Date of Expiry: <strong>{{date('d-m-Y', strtotime($estimate['expiry_date']))}}</strong> @else Credit Note Date: <strong>{{date('d-m-Y', strtotime($estimate['updated_at']))}}</strong> @endif</td>
                            </tr>
                            <tr>
                                <td height="25">&nbsp;State : <strong>{{$company['state']}}</strong></td>
                                <td style="border-left: solid 1px #000;" align="center"><strong>Code</strong></td>
                                <td style="border-left: solid 1px #000;" align="center">{{$company['state_code']}}</td>
                                <td style="border-left: solid 1px #000;" align="left">&nbsp;Country :<strong>India</strong></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                                ...
                                <td @if($print_type==2) colspan="2" @elseif($user['is_shipping']==0) colspan="2" @endif width="581px" height="25" style="border-right: solid 1px #000;">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            <td width="16%" style="border-left: solid 1px #000;" align="center"><strong>Code</strong></td>
    ...
    <tr>
        <td align="left" width="579px" valign="top" style="border-right: solid 1px #000;">
            <table width="100%" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td height="107" align="center">{{ucwords($estimate['total_in_word'])}} Rupees Only</td>
                </tr>
{{--                <tr>--}}
{{--                    <td align="left" style="border-top: solid 1px #000; padding:5px;"><strong>Payment Mode : </strong>{{$estimate['payment_method']}}</td>--}}
{{--                </tr>--}}
                <tr>
        ...
        <td width="599px" align="left" valign="top" >
            <table width="100%" border="0" cellspacing="0" cellpadding="2" style="margin-right: -1px; margin-bottom: -0.5px;">
                <tr>
                    ...
                    <td  width="299.5px" align="right" height="35"  style="border-right:0px;border-bottom:solid 1px #000;padding: 5px 5px;line-height:30px;">{{number_format($estimate['amount_before_tax'],2)}}/-</td>
                </tr>
                <tr>
                    ...
                    <td width="299.5px" align="right"  height="35"  style="border-right:0px;border-bottom:solid 1px #000;padding:5px 5px;line-height:30px;">{{number_format($estimate['tax_amount'],2)}}/-</td>
                </tr>
                    ...
                    <td width="299.5px" style="border-right:solid 1px #000;border-bottom:solid 1px #000;">
                        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse; margin-top:-2px; margin-bottom: -2px;">
                            <tr>
                                ...
                                <td align="right" style="padding:5px 5px;line-height:30px;border-left:solid 1px #000;">@if($estimate['discount_type']==1) {{$estimate['discount']}} % @else - @endif</td>
                            </tr>
                        </table>
                    </td>
                    <td width="299.5px" style="border-bottom:solid 1px #000;">
                        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse; margin-top:-2px; margin-bottom: -2px;">
                            <tr>
                                ...
                                <td align="right"  style="width:100px;padding:5px 5px;line-height:30px;border-left:solid 1px #000;">@if(!empty($estimate['discount_price']) && $estimate['discount_price']>0) {{$estimate['discount_price']}}/- @endif</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="299.5px" align="right"  style="border-right:0px;border-bottom:solid 1px #000;padding:5px 5px;line-height:30px;">{{number_format($estimate['total'],2)}}/-</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="299.5px" align="right"  style="border-right:0px;border-bottom:solid 1px #000;padding:5px 5px;line-height:30px;"><strong>{{number_format(round($estimate['total']),2)}}/-</strong></td>
                </tr>
                <tr>

                ...
                @endif
                    ...
                    <div class="form-row">
                        <div class="form-group mb-3 col-md-6">
                            ...
                            {!! Form::select('customer', $payees, isset($estimate)&&!empty($estimate)?$estimate['customer_id']:null, ['class' => 'form-control amounts-are-select2', 'id' => 'customer', 'onchange'=>'getEmail(this.value)']) !!}
                        ...
                        <div class="form-group mb-3 col-md-6">
                            <label for="estimate_number">Estimate number <span class="text-danger">*</span></label>
                            {!! Form::text('estimate_number', null, ['class' => 'form-control amounts-are-select2', 'id' => 'estimate_number']) !!}
                                    ...
                                    <div class="gstinvoice-table-data">
                                        <div class="table-responsive data-table-gst-box pb-3">
                                            <table class="table table-hover">
                                                ...
                                                <th width="20%" class="tax_column @if(isset($estimate)&&$estimate['tax_type']==3) hide @endif">Tax <span class="text-danger">*</span></th>
                                                <th width="4%">&nbsp;</th>
                                                </thead>

        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="overflow-x: hidden;">
                <form id="BillingAddressForm" method="POST" class="form-horizontal">
                    @csrf
                    <input type="hidden" name="customer_id" id="billing_cust_id" value="@if(isset($estimate)) {{$estimate['customer_id']}} @endif">
                    <div class="row" id="CustomersBillingAddress">
                        <div class="col-md-12">
                            <div class="form-group mb-3 row">
                                ...
                                <div class="col-md-12">
                                    {!! Form::text('billing_name', isset($estimate) && !empty($estimate)?$estimate['customer']['billing_name']:null, ['class' => 'form-control','id'=>'billing_name_1']) !!}
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3 row">
                                ...
                                <div class="col-md-12">
                                    {!! Form::text('billing_phone', isset($estimate) && !empty($estimate)?$estimate['customer']['billing_phone']:null, ['class' => 'form-control','id'=>'billing_phone_1']) !!}
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3 row">
                                ...
                                <div class="col-md-12">
                                    {!! Form::text('billing_street', isset($estimate) && !empty($estimate)?$estimate['customer']['billing_street']:null, ['class' => 'form-control','id'=>'billing_street_1']) !!}
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3 row">
                                ...
                                <div class="col-md-12">
                                    {!! Form::text('billing_city', isset($estimate) && !empty($estimate)?$estimate['customer']['billing_city']:null, ['class' => 'form-control','id'=>'billing_city_1']) !!}
                                ...
                                <div class="col-md-12">
                                    <select name="billing_state" class="form-control amounts-are-select2" id="billing_state_1" style="width: 100%;">
                                        @foreach($address_states as $add)
                                            <option value="{{$add['id']}}" @if(isset($estimate) && !empty($estimate) && $estimate['customer']['billing_state']== $add['id']) selected @endif>{{$add['state_name']}}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3 row">
                                ...
                                <div class="col-md-12">
                                    {!! Form::text('billing_pincode', isset($estimate) && !empty($estimate)?$estimate['customer']['billing_pincode']:null, ['class' => 'form-control','id'=>'billing_pincode_1']) !!}

                                                ...
                                                <table width="100%" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td width="50%" align="left" style="background-color:#{{$company->color}}; border: solid 1px #{{$company->color}};">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td style="font-size:14px; padding:10px 10px 0 10px; color:#fff;">Estimate Date</td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="left" style="font-size:14px; font-weight: normal; text-transform: uppercase; color:#383838; padding:5px 10px 10px 10px; color:#fff;">
                                                                        <strong>{{date('d-m-Y', strtotime($estimate['estimate_date']))}}</strong>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                        <td width="50%" style="border: solid 1px #{{$company->color}};">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td align="left" style="font-size:14px; padding:10px 10px 0 10px;">Estimate No.</td>
                                                                </tr>
                                                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td width="40%" align="right" valign="top">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tbody>
    {{--                                        <tr>--}}
    {{--                                            <td colspan="2" align="left" valign="middle" style="font-size:12px; font-weight:bold; padding-bottom: 5px;">{{ $estimate_label["shipping_method"] }}</td>--}}
    {{--                                        </tr>--}}
    {{--                                        <tr>--}}
...
{{--            @for($j=1; $j<=($estimate['EstimateItems']->count()>0?10-$estimate['EstimateItems']->count():10); $j++)--}}
{{--                <tr>--}}
{{--                    <td style="width: 5%; background-color: #ffffff!important;">&nbsp;</td>--}}
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td height="24" width="110" align="right" style="font-size:12px;padding:0 0px;">
                                                        <strong>{{number_format($estimate['amount_before_tax'],2)}}</strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="24" align="right" style="font-size:12px;padding-right:10px;">
                                                    ...
                                                    <td height="24" align="right" style="font-size:12px;padding:0 5px;">
                                                        <strong>{{number_format($estimate['tax_amount'],2)}}</strong>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td height="24" align="right" style="font-size:12px;padding:0 5px;">
                                                        <strong> @if(!empty($estimate['discount_price'])){{$estimate['discount_price']}} @else - @endif</strong>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td height="24" align="right" style="font-size:12px;padding:0 5px;">
                                                        <strong>{{$estimate['shipping_charge']==1 ? number_format($estimate['shipping_charge_amount'],2).'' : '-' }}</strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="24" align="right" style="font-size:12px;padding-right:10px;">
                                                    ...
                                                    <td height="24" align="right" style="font-size:12px;padding:0 5px;">
                                                        <strong>{{number_format($estimate['total'],2)}}</strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="24" align="right" style="font-size:12px;padding-right:10px;">

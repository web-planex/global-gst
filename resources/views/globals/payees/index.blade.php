...
@section('content')
    ...
    <div class="row">
        <div class="col-12 page-min-height">
            @include('inc.message')
            {!! Form::open(['url' => url('payees'),'method'=>'get', 'class' => 'form-horizontal top-heading-form-box','files'=>true,'id'=>'SearchForm']) !!}
                <div class="row">
                    <div class="col-md-3">
            ...
            <div class="card">
                ...
                <div class="row pb-3">
                    <div class="col-md-6 pl-4">
                        Showing {{$payees->firstItem()}} to {{$payees->lastItem()}} of {{$payees->total()}} entries
                    </div>

        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="ShippingAddressForm" method="POST" class="form-horizontal">
                    @csrf
                    <input type="hidden" name="customer_id" id="shipping_cust_id" value="@if(isset($invoice)) {{$invoice['customer_id']}} @endif">
                    <div class="row" id="Customers">
                        <div class="col-md-12">
                            <div class="form-group mb-3 row">
                                <label for="shipping_name" class="col-md-12 col-form-label">Shipping Name <span class="text-danger"></span></label>
                                <div class="col-md-12">
                                    {!! Form::text('shipping_name', isset($invoice) && !empty($invoice)?$invoice['customer']['shipping_name']:null, ['class' => 'form-control','id'=>'shipping_name_1']) !!}
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3 row">
                                ...
                                <div class="col-md-12">
                                    {!! Form::text('shipping_phone', isset($invoice) && !empty($invoice)?$invoice['customer']['shipping_phone']:null, ['class' => 'form-control','id'=>'shipping_phone_1']) !!}
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3 row">
                                ...
                                <div class="col-md-12">
                                    {!! Form::text('shipping_street', isset($invoice) && !empty($invoice)?$invoice['customer']['shipping_street']:null, ['class' => 'form-control','id'=>'shipping_street_1']) !!}
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3 row">
                                ...
                                <div class="col-md-12">
                                    {!! Form::text('shipping_city', isset($invoice) && !empty($invoice)?$invoice['customer']['shipping_city']:null, ['class' => 'form-control','id'=>'shipping_city_1']) !!}
                                ...
                                <div class="col-md-12">
                                    <select name="shipping_state" class="form-control amounts-are-select2" id="shipping_state_1" style="width: 100%;">
                                        @foreach($address_states as $add)
                                            <option value="{{$add['id']}}" @if(isset($invoice) && !empty($invoice) && $invoice['customer']['shipping_state']== $add['id']) selected @endif>{{$add['state_name']}}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3 row">
                                ...
                                <div class="col-md-12">
                                    {!! Form::text('shipping_pincode', isset($invoice) && !empty($invoice)?$invoice['customer']['shipping_pincode']:null, ['class' => 'form-control','id'=>'shipping_pincode_1']) !!}

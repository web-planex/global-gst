                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td height="24" width="110" align="right" style="font-size:12px;padding:0 0px;">
                                                        <strong>{{number_format($invoice['amount_before_tax'],2)}}</strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="24" align="right" style="font-size:12px;padding-right:10px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td height="24" align="right" style="font-size:12px;padding:0 5px;">
                                                        <strong> @if(!empty($invoice['discount_price'])){{$invoice['discount_price']}} @else - @endif</strong>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td height="24" align="right" style="font-size:12px;padding:0 5px;">
                                                        <strong>{{$invoice['shipping_charge']==1 ? number_format($invoice['shipping_charge_amount'],2).'' : '-' }}</strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="24" align="right" style="font-size:12px;padding-right:10px;">

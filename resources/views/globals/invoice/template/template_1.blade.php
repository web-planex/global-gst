                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                            <tr>
                                                <td align="left" style="font-size:14px; padding-bottom: 5px;">
                                                    <strong style="color:#{{$company->color}};">Invoice No: </strong>{{$invoice['invoice_number']}}
                                                </td>
                                            </tr>
                                            <tr>
    ...
    <table align="center" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            @if($invoice['tax_type'] != 3)
                <td width="40px" align="center" valign="top" bgcolor="#{{$company->color}}" style="color: #ffffff; border-left: solid 2px #fff; padding:0 5px;line-height:30px; text-transform: uppercase;"><strong>GST <br> <span style="font-family: DejaVu Sans; sans-serif;">(%)</span></strong></td>
            @endif
            @if($invoice['tax_type'] != 3)
        ...
        @if(!empty($invoice['InvoiceItems']))
            ...
            @for($j=1; $j<=($invoice['InvoiceItems']->count()>0?10-$invoice['InvoiceItems']->count():10); $j++)
                        ...
                        <td align="right" width="40%" align="left" valign="top">
                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                ...
                                <tr class="odd">
                                    ...
                                    <td height="35" align="right" style="border: solid 2px #fff; padding:0 10px;">
                                        @if(!empty($invoice['discount_price'])){{$invoice['discount_price']}} @else - @endif
                                    </td>
                                </tr>
                                <tr class="even">
                                    <td height="35" align="right" style="border: solid 2px #fff; padding-right:10px;">
                                ...
                                <tr bgcolor="#{{$company->color}}">
                                    ...
                                    <td height="38" align="right" style="padding:6px 10px; font-size: 18px; color: #fff; border: solid 2px #fff;">
                                        <strong>{{number_format(round($invoice['total']),2)}}</strong>
                                    </td>
                                </tr>
                                </tbody>
                            </table>

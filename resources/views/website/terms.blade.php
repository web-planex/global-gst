...
@section('content')
    ...
    <section id="terms_conditions" class="s_pricing_area sec_pad pb-0">
        <div class="container custom_container">
            <div class="sec_title mb_70">
                <h2 class="f_p f_size_30 l_height50 f_600 t_color3">Terms & Conditions</h2>
                <p class="f_400 f_size_18 l_height34">
                    Webplanex Infotech Private Limited developed a web application available as website. These terms and conditions govern the use of or access to the Platform and the Services.
                </p>
                <p class="f_400 f_size_18 l_height34">
                    These Terms constitute a binding and enforceable legal contract between the Company and a User (as defined below) or any end user of the Services. You represent and warrant that you (a) have full legal capacity and authority to agree and bind yourself to these Terms, (b) are 18 (eighteen) years of age or older, and (c) are an Indian resident. If you represent an entity, organization, or any other legal person, you confirm and represent that you have the necessary power and authority to bind such entity, organization, or legal person to these Terms.
                </p>
                <p class="f_400 f_size_18 l_height34">
                ...
                <p class="f_400 f_size_18 l_height34">
                    ...
                    If the Refund request is reported to us through email / website within 7 days of purchase and we will give you 100% money back. The refund request should be raised via email or website.
                </p>
            </div>
        </div>
    </section>

 ...
 * ==========================================================
 *
 * Library of static html components. This file must not be executed directly. © 2021 board.support. All rights reserved.
 *
 */
...
function sb_login_box() { ?>
    <form class="sb sb-rich-login sb-admin-box">
        ...
        <div class="sb-top-bar">
            ...
            <div class="sb-text"><?php sb_e(sb_get_setting('login-message', 'To continue to Support Board')) ?></div>
        </div>
        <div class="sb-main">
...
function sb_component_admin() {
    ...
    $apps = [
        ...
        ['SB_PERFEX', 'perfex', 'Perfex', 'Let\'s Perfex customers contact you via chat! View profile details in the admin area, and integrate smart chatbots.'],
        ...
        ['SB_AECOMMERCE', 'aecommerce', 'Active eCommerce', 'Increase sales, and connect in real-time with your customers by integrating Active eCommerce with Support Board.']
    ];
...
function sb_apps_panel() {
    ...
    $panels = [['SB_UMP', 'ump'], ['SB_WOOCOMMERCE', 'woocommerce'], ['SB_PERFEX', 'perfex'], ['SB_WHMCS', 'whmcs'], ['SB_AECOMMERCE', 'aecommerce']];
